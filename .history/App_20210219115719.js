...
const configs = {
  provider: {
    issuer:
      'https://idpsesiont.telecom.com.ar:443/openam/oauth2/realms/fintech-app',
    clientId: 'oidc-fintechapk-test',
    redirectUrl: 'com.identicum.mobile.demo:/oauthredirect',
    additionalParameters: {},
    scopes: ['openid', 'profile'],
    serviceConfiguration: {
      authorizationEndpoint:
        'https://idpsesiont.telecom.com.ar:443/openam/oauth2/realms/fintech-app/authorize',
      tokenEndpoint:
        'https://idpsesiont.telecom.com.ar:443/openam/oauth2/realms/fintech-app/access_token',
      revocationEndpoint:
        'https://idpsesiont.telecom.com.ar:443/openam/oauth2/realms/fintech-app/token/revoke',
    },
  },
};
...
class App extends Component {
  ...
  render() {
    ...
    let decodedJwt;
    if (loggedIn) decodedJwt = this.decodeJwt(this.state.idToken);
    console.log('___ Is User logged in : ' + loggedIn);
    return (
      <View style={styles.container}>
        <View>
          <Text style={styles.headerText}>
            {loggedIn ? 'User: ' + decodedJwt.sub : 'Welcome'}{' '}
          </Text>
        </View>
